...
public class MapsActivityRoute extends FragmentActivity implements OnMapReadyCallback {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent intent1 = new Intent(MapsActivityRoute.this, MapsActivityRoute.class);
               ...
               //     mTextMessage.setText(R.string.title_sesion);
                    Intent intent = new Intent(MapsActivityRoute.this, LoginActivity.class);
                ...
                case R.id.navigation_money:
                   // mTextMessage.setText(R.string.title_money);
                    ...
                    Intent intent2 = new Intent(MapsActivityRoute.this, BudgetActivity.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(34.01, -118.49);
